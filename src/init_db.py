...
def init_db():
    ...
    producten = [
        ...
        ("5001", "Broodjes", "Broodje kaas", 3.50, 6),
        ("5002", "Broodjes", "Broodje ham", 3.50, 5),
        ("5003", "Broodjes", "Broodje ham en kaas", 3.70, 4),
        ("5004", "Broodjes", "Broodje gezond", 4.00, 4),
        ("5005", "Broodjes", "Broodje gehaktbal", 3.90, 5),
        ("5006", "Broodjes", "Broodje carpaccio", 4.20, 4),
        ("5007", "Broodjes", "Broodje kipfilet", 3.90, 5),
        ("5008", "Broodjes", "Broodje tonijn", 4.10, 4),
        ("5009", "Broodjes", "Broodje kip krokant", 4.00, 3),
        ("5010", "Broodjes", "Broodje blt", 4.50, 4),
        ("5011", "Broodjes", "Broodje eiersalade", 3.60, 3),
        ("5101", "Broodjes", "Panini ham & kaas", 4.20, 4),
        ("5102", "Broodjes", "Panini tomaat mozarella", 4.40, 4),
        ("5103", "Broodjes", "Panini big mac", 4.60, 4),
