...
def init_db():
    ...
    producten = [
        ...
        ("5003", "Broodjes", "Broodje gezond", 4.00, 4),
        ("5004", "Broodjes", "Broodje gehaktbal", 3.90, 5),
        ("5005", "Broodjes", "Broodje carpaccio", 4.20, 4),
        ("5006", "Broodjes", "Broodje kipfilet", 3.90, 5),
        ("5007", "Broodjes", "Broodje tonijnsalade", 4.10, 4),
